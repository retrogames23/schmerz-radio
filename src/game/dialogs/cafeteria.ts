...
export const cafeteriaDialogs: Record<string, DialogTree> = {
  ...
  cafeteriaVossbeck: {
    ...
    lines: {
      ...
      // Akt II — Vossbecks Reaktion hängt am Mira-State. Drei Varianten,
      // ein gemeinsamer Eingang. Inhalte so, dass sie auch ohne weitere
      // Akt-II-Szenen schon Atmosphäre stiften.
      vAct2Friendly: {
        id: "vAct2Friendly",
        speaker: "VOSSBECK",
        text: "Worag. Wieder hier. — Ich habe gehört, auf 104,0 sendet jetzt jemand mit Verstärker. Sie wissen sicher nichts davon.",
        subtext: "Der Bleistift bleibt senkrecht. Aber er sieht Layard länger an als nötig.",
        requires: ["duelEndgameWon", "act2Started", "miraEndFriendly"],
        end: true,
      },
      vAct2Neutral: {
        id: "vAct2Neutral",
        speaker: "VOSSBECK",
        text: "Worag. Falls Sie eine Fallnummer haben — ich bin pragmatisch. Falls nicht, gilt: Tür ist da.",
        subtext: "Pragmatisch klingt aus seinem Mund wie eine Drohung.",
        requires: ["duelEndgameWon", "act2Started", "miraEndNeutral"],
        end: true,
      },
      vAct2Skeptical: {
        id: "vAct2Skeptical",
        speaker: "VOSSBECK",
        text: "Worag. Setzen Sie sich. — Manche Bewohner halten meine Paragraphen für ein Hindernis. Andere für ein Werkzeug. Sie scheinen mir zur zweiten Sorte zu gehören.",
        subtext: "Erstmals legt er den Bleistift hin. Er klingt fast einladend.",
        requires: ["duelEndgameWon", "act2Started", "miraEndSkeptical"],
        end: true,
      },
    },
  },
