...
REGELN:
  ...
  - SPRACHE — PFLICHT: Schreibe ausschließlich echte, im Duden existierende deutsche Wörter. Erfinde KEINE Verben oder Adjektive, auch nicht in *Aktions-Sternchen* (also NICHT „*rầyelt sich die Schultern*", „*schmunzelnickt*", „*grummelseufzt*"). Verwende keine ungewöhnlichen diakritischen Zeichen (â, ầ, ã, ẽ …) in deutschen Wörtern — nur ä, ö, ü, ß sind erlaubt. Wenn dir kein passendes Verb einfällt, nimm ein einfaches („zuckt mit den Schultern", „räuspert sich", „rückt unruhig hin und her"). Im Zweifel lieber schlicht als kreativ-erfunden.
