...
export const CHANNELS: Channel[] = [
  {
    ...
    bulletins: [
      ...
      "Quadrant E71-Nord. Die Einhaltung der Resonanz-Hygiene in ihrer bau-akustischen wie in ihrer sozialen Auslegung wird ausdrücklich erinnert. Abweichungen werden, soweit sie als Abweichungen in Erscheinung treten, einer angemessenen Würdigung zugeführt.",
      ...
      "Sektor E84. Hinweise auf eine erhöhte Zahl von Ruhezeit-Beschwerden aus den oberen Etagen werden zur Kenntnis genommen und in den allgemeinen Erkenntnisfluss überführt.",
  ...
  },
  {
    ...
    ticker:
      "+++ Bekanntmachung +++ Anpassung der Sprechzeiten in den nicht öffentlich zugänglichen Bereichen +++ Hinweise zur Resonanz-Hygiene (Ruhezeiten, Belegungsdichte, Türsiegel-Praxis) sind unverändert gültig +++ Antragsformular B-3a in der Fassung vom Vortag weiterhin anwendbar +++ Bei Rückfragen gilt die Auskunftslage des Vortages +++",
    hold: 13,
    ...
    bulletins: [
      ...
      "Resonanz-Hygiene, Erinnerung. Die Bewohnerinnen und Bewohner werden daran erinnert, dass Ruhezeiten Bestandteil der Resonanz-Hygiene sind und in der jeweils gültigen Fassung einzuhalten sind.",
      "Resonanz-Hygiene, Ergänzung. Belegungsdichte, Lüftungsverhalten und die Praxis der Türsiegel-Beachtung tragen in gleicher Weise zur Einhaltung der Resonanz-Hygiene bei wie die Einhaltung der Ruhezeiten.",
  ...
  },
  {
    ...
    ticker:
      "+++ Resonanzindex im Mittel +++ Mischgröße aus bau-akustischen Messwerten und sozialen Kennzahlen +++ keine sektorenübergreifenden Auffälligkeiten +++ punktuelle Erhöhungen werden im Rahmen der dafür vorgesehenen Glättung berücksichtigt +++ Empfehlung: Innenräume bevorzugen, Ruhezeiten wahren, Resonanz-Hygiene beachten +++",
    hold: 12,
    videoUrl: anchorWetterAsset.url,
    voiceId: "XB0fDUnXU5powFXDhCwa",
    accentClass: "text-cyan-200",
    bulletins: [
      "Sektorenübergreifend. Der Resonanzindex — Mischgröße aus bau-akustischen Messwerten und der Zahl der Krankmeldungen und Nachbarschaftsbeschwerden — bewegt sich innerhalb der Bandbreite, die als die entsprechende Bandbreite anerkannt ist.",
      "Sektor E67. Resonanzindex: im Erwartungsbereich. Sowohl die tieffrequenten Körperschallwerte als auch die Zahl der eingegangenen Ruhezeit-Beschwerden liegen im Rahmen des Üblichen.",
      "Sektor E71. Resonanzindex: erhöht — sowohl bau-akustisch als auch in den Krankmeldungen der zurückliegenden Woche —, jedoch nicht erhöht im Sinne der für eine Erhöhung vorgesehenen Schwellen. Eine Veröffentlichung erfolgt daher nicht.",
      ...
      "Hinweis zur Resonanz-Hygiene. In Wohneinheiten mit dünnen Zwischendecken wird ausdrücklich daran erinnert, dass Körperschall in beide Richtungen wirkt und die Einhaltung der Ruhezeiten Teil der Resonanz-Hygiene ist.",
      "Hinweis zu tieffrequenten Wahrnehmungen. Vereinzelt gemeldetes Brummen in Stahlbeton-Großkomplexen kann nicht ausgeschlossen werden. Es kann jedoch auch nicht als bestätigt gelten.",
      "Hinweis zu tieffrequenten Wahrnehmungen, Ergänzung. Eine Mitteilung an die für Bau-Akustik zuständige Stelle ist möglich. Eine Bestätigung des Eingangs erfolgt, sofern eine Bestätigung erfolgt.",
      ...
      "Sektor E61. Es liegen einzelne Meldungen über sogenanntes „inneres Mitschwingen“ zwischen benachbarten Wohneinheiten vor. Diese Meldungen werden im Rahmen der sozialen Resonanz-Auslegung zur Kenntnis genommen, sofern sie als zur Kenntnis zu nehmende Meldungen vorliegen.",
      ...
      "Sektor E71, Korridor 15. Eine ergänzende Resonanzbeobachtung ist nicht vorgesehen, da eine Beobachtung in einem Bereich mit der medizinischen Funktion dieses Korridors nicht vorgesehen ist.",
      ...
      "Allgemeiner Hinweis. Bewohnerinnen und Bewohner werden gebeten, bei subjektiv wahrgenommener Unruhe im eigenen Umfeld — sei es baulich, sei es nachbarschaftlich — den Aufenthalt in Innenräumen zu bevorzugen und die Ruhezeiten wechselseitig zu wahren.",
      "Allgemeiner Hinweis, Ergänzung. Eine Selbstbeobachtung ersetzt die Beobachtung durch die hierfür zuständige Stelle nicht. Über die Gewichtung bau-akustischer und sozialer Kennzahlen im Resonanzindex entscheidet ausschließlich der Mandatsrat.",
