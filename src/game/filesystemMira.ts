...
export const Z_K_S_MANIFEST: string[] = [
  ...
  "die sich weitergibt.",
  "",
  "1.  Wir glauben, dass Resonanzhygiene keine Hygiene ist,",
  "    sondern eine Dressur. Wir können das nicht beweisen.",
  "    Aber wenn wir recht haben, ist sie eine Leine.",
  ...
  children: [
    ...
    },
    {
      ...
      content: [
        ...
        "",
        "bodo (2612):    hat einen anker hier. wer einen",
        "                anker hat, hat etwas zu verlieren.",
        "                das ist kein vorwurf. es ist physik.",
        "",
    ...
    },
    {
      ...
      date: "—",
      content: [
        "── an_mama.md — entwurf, nie verschickt ──────",
        "",
        "mama,",
        "",
        "ich bin 16. ich wohne allein in 4601. das",
        "wolltest du so. ich auch. wir müssen nicht",
        "drüber reden, wer wann nicht mehr konnte.",
        "",
        "in E54-2207 ist es bestimmt ruhig. hier ist",
        "es nicht ruhig, aber das wusstest du, als",
        "du mich bei roald gelassen hast.",
        "",
        "papa wäre stolz auf das, was ich mache.",
        "(ich weiß, du würdest sagen, papa wäre",
        "BESORGT. das ist dasselbe, nur höflicher.)",
        "",
        "schreib mir. nicht als brief. einfach kurz.",
    ...
    },
    {
      ...
      date: "—",
      content: [
        "── zettel von onkel roald, 4604 ──────────────",
        "",
        "mira,",
        "",
        "der schalter im 38er ist wieder durch. dein",
        "vater hätte gelacht und gesagt, »das ist die",
        "etage, die uns nicht mag«. ich habs gemeldet,",
        "marschke kommt morgen.",
        "",
        "iss mal was warmes.",
        "",
        "                                       — roald",
    ...
    },
    {
      ...
      content: [
        ...
        "   keine zeugen. keine wartungslogs",
        "   sekunden vor vorfall. fall geschlossen.«",
        "",
        "keine wartungslogs SEKUNDEN VORHER.",
        "der schacht hatte sensoren auf jedem meter.",
        "die haben nicht von alleine geschwiegen.",
        "",
        "ich war 11. ich bin nicht mehr 11.",
        "                                          — m.",
      ],
    },
  ],
