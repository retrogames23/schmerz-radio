...
export const npcPersonas: Record<string, NpcPersona> = {
  ...
  bodo: {
    ...
    biography: [
      ...
      "Werdegang: Mit 18 Lehre als Fernmeldetechniker, 26 Jahre im Beruf bei den alten Stadtwerken — UKW-Sendemasten, Relais, Repeater. Am Rand auch die Bastler-Szene rund um Cornel Marteau gekannt; Schmerz-Radio war schon damals ein privates Hobby-Ding, kein Stadtwerk-Auftrag.",
