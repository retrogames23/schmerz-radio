 ...
 *
 * Jede Sektion ist ein eigener Block mit Titel und Einträgen.
 * Die Einträge werden in der UI durchsuchbar dargestellt — sowohl
 * Tastatur (Desktop) als auch Touch-Bedienung (Mobile) sind hier
 * dokumentiert. Keine Story-Spoiler, nur Mechaniken.
 */

export interface HelpEntry {
  /** Kompakte Beschriftung der Aktion. */
  label: string;
  /** Verknüpfte Tasten/Gesten — Reihenfolge: Desktop, dann Mobile. */
  keys: string[];
  /** Erklärender Fließtext (1–3 Sätze). */
  description: string;
  /** Zusätzliche Schlagworte für die Suche. */
  tags?: string[];
}
...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    intro:
      "Gefundene Gegenstände landen in deiner Aktentasche unten am Bildschirmrand.",
    entries: [
      {
        label: "Aktentasche öffnen",
        keys: ["Klick auf Aktentasche", "Mobile: Tippen"],
        description:
          "Die Aktentasche bleibt immer am unteren Rand sichtbar. Klicke oder tippe darauf, um alle Gegenstände einzusehen.",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        description:
          "In Gesprächen erscheinen Antwortoptionen. Wähle eine durch Klick oder Tipp aus.",
