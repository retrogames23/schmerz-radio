...
export const scenes: Record<string, Scene> = {
  ...
  hallway: {
    ...
    doorPlates: [
      // Even numbers, right side of corridor
      { id: "p2610", x: 12, y: 26, w: 9, label: "2610" },
      { id: "p2612", x: 38, y: 26, w: 9, label: "2612" },
      { id: "p2614", x: 64, y: 26, w: 9, label: "2614" },
      // Odd numbers, left side of corridor (Layard's side)
      { id: "p2611", x: 25, y: 70, w: 9, label: "2611" },
      // 2613 — normal label before/after, ⚠ after the protocol is sealed
      {
        id: "p2613",
        x: 51,
        y: 70,
      ...
      { id: "p2615", x: 77, y: 70, w: 9, label: "2615" },
    ],
    hotspots: [
      {
        id: "back2611",
