  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-4 left-16 z-[120] flex h-10 items-center justify-center rounded-full border border-amber-glow/60 bg-background/80 px-3 font-mono-crt text-xs text-amber-glow shadow-lg hover:bg-amber-glow/15"
      >
