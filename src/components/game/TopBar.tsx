...
function TopBarImpl({ onOpenPause, onOpenHelp }: Props) {
  ...
  const hideMusicSwitcher = music.activeOverride === "sectorThreshold" || music.activeOverride === "miraRoom" || music.activeOverride === "miraRoom2" || scene === "elevator" || scene === "elevatorE71" || !!busRide;
