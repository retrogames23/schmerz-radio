...
function TopBarImpl({ onOpenPause, onOpenHelp }: Props) {
  ...
  const hideMusicSwitcher = music.activeOverride === "sectorThreshold" || music.activeOverride === "miraRoom" || music.activeOverride === "miraRoom2" || music.activeOverride === "miraRoom3" || scene === "elevator" || scene === "elevatorE71" || !!busRide;
