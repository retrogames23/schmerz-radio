    ...
    if (raw === "tap") {
      ...
      runScripted(
        [
          ...
          { text: ">> ─────────── EINGANG ──────────────", delayMs: 380, kind: "system" },
          { text: '   "… ich bin müde, aber das ist kein …"', delayMs: 700, kind: "warn" },
          { text: '   "… B2 schmeckt nach gar nichts mehr …"', delayMs: 900, kind: "warn" },
          { text: '   "… warum hat sie heute »Sie schon wieder« …"', delayMs: 900, kind: "warn" },
          { text: '   "… ich habe ja gesagt. ich hätte nein sagen …"', delayMs: 900, kind: "warn" },
          { text: '   "… der mann mit den grünen augen …"', delayMs: 900, kind: "warn" },
