...
import {
  ...
  visibleChildren,
  type Line,
} from "@/game/terminal/terminalHelpers";
...
export function Terminal() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (cmd === "help") {
      ...
      // Veralteter Akt-I-Pfad: Layard hat Bodos Terminal früher selbst
      // benutzt, um die Quittung zusammenzusetzen. Heute macht Frau Kowalk
      // das hinter der Theke — der Befehl bleibt nur als nostalgischer
      // Hinweis stehen.
      if (!bodoMode) {
        newLines.push({
        ...
        newLines.push(
          {
            text: "forge: Frau Kowalk macht das selbst hinter der Theke.",
            kind: "out",
          },
          {
            text: "       (Bring ihr Bleistiftstummel, Quittungsblanko und den Siegelabdruck.)",
            kind: "out",
          },
        );
      }
