...
function MusicToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 right-4 z-[80] flex items-center gap-2 rounded-full bg-black/60 px-3 py-2 text-sm text-white/90 backdrop-blur-sm transition-colors hover:bg-black/80"
    >
      {musicEnabled ? (
        <>
