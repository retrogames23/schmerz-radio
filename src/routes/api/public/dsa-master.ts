          ...
          const opener: StoredTurn = {
            ...
            content:
              runtimeMode === "e67"
                ...
                : "(SPIELLEITER-CUE: Eröffne das Abenteuer. Wende dich ZUERST als Tjark kurz direkt an den Spieler (1–2 Sätze, [TJARK]-Zeile, Anrede mit »du« — KEIN Eigenname, weder »Layard« noch der Charaktername) und weise ihn darauf hin, dass er dich jederzeit mit dem Stichwort »Outtime« ansprechen kann, wenn er Regelfragen oder Fragen zur Welt Aventuriens hat — und dass du für manche In-World-Wissensfragen (Etikette, Heraldik, Götter, Geschichte, Magiekunde) eine passende Probe verlangen kannst. DANACH setze die Szene mit [SCENE: …], beschreibe in 2–4 Sätzen, wo der Charakter des Spielers mit Brem und Yelva steht und was sie umgibt. Sprich den Charakter dabei mit seinem Namen oder Titel an, NIEMALS mit »Layard«. Schließe mit einer offenen Frage an die Gruppe oder einer ersten Beobachtung. Noch kein Kampf.)",
          };
